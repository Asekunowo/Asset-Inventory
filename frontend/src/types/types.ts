...
export interface ChangePassword {
	changePass: (password: {oldPassword: string; newPassword: string; confirmNewPassword: string}) => Promise<{success: boolean; message: string}>;
}
...
export interface ExitRegisterData {
	...
	reassignment_type: "NONE" | "NEW_ASSIGNMENT" | "REFRESH" | "STOP_GAP" | "OBSOLETE";
	createdAt?: Date;
